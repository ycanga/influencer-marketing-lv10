            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Yeni Talep Oluştur</h5>
                                ...
                                <form action="{{route('demand.store')}}" method="POST">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="subject">Talep Tutarı (₺) <b class="text-danger">*</b> </label>
                                            <div class="form-text mb-1">
                                                <b class="text-danger">*</b>
                                                Talep edeceğiniz tutarı giriniz. (Talep edilen tutar için bakiyenizin
                                                yeterli olması gerekmektedir.)
                                            </div>
                                            <input type="number" class="form-control" id="amount" name="amount"
                                                placeholder="Talep edilen tutarı giriniz." required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="message">Talep Açıklaması</label>
                                            <div class="input-group">
                                                <textarea class="form-control" id="desc" name="desc"
                                                    placeholder="Talep edilen işlem için açıklama girebilirsiniz."></textarea>
                                            </div>
                                        </div>
