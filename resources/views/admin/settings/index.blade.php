                    ...
                    <div class="card-body">
                        <form action="{{route('admin.settings.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_title" id="site_title" class="form-control" value="{{$settings->site_title ?? ''}}" placeholder="Site başlığını giriniz...">
                            </div>
                            <div class="form-group mt-3">
                                ...
                                <textarea name="site_description" id="site_description" class="form-control" rows="5" placeholder="Site açıklamasını giriniz...">{{$settings->site_description ?? ''}}</textarea>
                            </div>
                            <div class="form-group mt-3">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="site_min_balance" id="site_min_balance" class="form-control"
                                    value="{{$settings->site_min_balance ?? ''}}" placeholder="Minimum bakiye tutarı giriniz...">
                            </div>
                            <div class="form-group mt-3">
